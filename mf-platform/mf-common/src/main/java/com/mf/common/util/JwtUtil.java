...
public final class JwtUtil {
    ...
    public static String generateWithUserType(Long userId, String username, String role, String userType) {
        return Jwts.builder().id(String.valueOf(userId)).subject(username)
                .claim("role", role).claim("userType", userType)
    ...
    public static Long getUserId(Claims claims) { return Long.valueOf(claims.getId()); }
    public static String getUsername(Claims claims) { return claims.getSubject(); }
    public static String getRole(Claims claims) { return claims.get("role", String.class); }
    public static String getUserType(Claims claims) { return claims.get("userType", String.class); }
}
