    ...
    children: [
      {
        ...
        meta: { title: '肥料管理', icon: 'Shop' }
      },
      {
        path: 'tree',
        name: 'Tree',
        component: () => import('@/views/tree/index.vue'),
        meta: { title: '树木管理', icon: 'Grid' }
      },
      {
        path: 'record',
        name: 'Record',
        component: () => import('@/views/record/index.vue'),
        meta: { title: '施肥记录', icon: 'Document' }
      },
      {
        path: 'rule',
        name: 'Rule',
        component: () => import('@/views/rule/index.vue'),
        meta: { title: '施肥规则', icon: 'Setting' }
      },
      ...
      { path: 'admin/faqs', name: 'AdminFaqs', component: () => import('@/views/admin/Faqs.vue'), meta: { title: 'FAQ管理' } },
