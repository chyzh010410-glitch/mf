...
.login-page {
  display: flex;
  height: 100vh;
  background: linear-gradient(135deg, #e8f5e9 0%, #f5fdf7 40%, #ffffff 100%);
  overflow: hidden;
}
...
.drop-body {
  width: 18px;
  height: 26px;
  background: linear-gradient(180deg, #82d4a0 0%, #2d8c4a 100%);
  border-radius: 50% 0 50% 50%;
  transform: rotate(45deg);
  opacity: 0.9;
  box-shadow: inset -2px -2px 4px rgba(0,0,0,0.1), 0 2px 8px rgba(45,140,74,0.3);
}
...
.ripple {
  ...
  border: 2px solid rgba(45,140,74,0.4);
  border-radius: 50%;
  opacity: 0;
}
...
.stem {
  ...
  width: 3px;
  height: 0;
  background: linear-gradient(180deg, #3cb060 0%, #2d8c4a 100%);
  border-radius: 2px;
  opacity: 0;
...
.leaf-left {
  left: calc(50% - 3px);
  background: linear-gradient(135deg, #4cc864 0%, #2d8c4a 100%);
...
.leaf-right {
  left: calc(50% - 3px);
  background: linear-gradient(225deg, #4cc864 0%, #2d8c4a 100%);
